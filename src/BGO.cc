...
BGO::BGO(const _type type, const G4String name)
{
    ...
    G4UnionSolid* mother_s = new G4UnionSolid("BGO_" + name + "_mother_solid", mother_zyl_s, mother_cons_s, nullptr, G4ThreeVector(0., 0., -full_length / 2.));
    G4Material* mother_mat = G4Material::GetMaterial("Galactic");

    mother_lv = new G4LogicalVolume(mother_s, mother_mat, "BGO_" + name + "_mother_lv");
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0., 0., -(full_length / 2. + cone_length / 2.)), nose_lv, "BGO_" + name + "_nose", mother_lv, false, 0);
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0., 0., 0.), bgo_lv, "BGO_" + name + "_bgo", mother_lv, false, 0);
}
