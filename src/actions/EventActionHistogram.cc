...
inline G4THitsMap<G4double>* EventActionHistogram::GetHitsCollection(const G4int id, const G4Event* event) const
{
...
inline G4double EventActionHistogram::GetSum(const G4THitsMap<G4double>* hits) const
{
...
void EventActionHistogram::BeginOfEventAction(const G4Event* /*anEvent*/)
{
}
